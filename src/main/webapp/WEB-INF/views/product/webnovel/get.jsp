			...
			<form action="${appRoot}/product/webnovel/detail" method="get" id="webnovel-get-form" class="form-inline">
				...
				<div id="div-get-detail" class="ml-3">
					<div id="div-get-detail-pname">
						<span id="pname">${webnovel.product_name}</span>
					</div>
					<div id="div-get-detail-likecomment">
						...
						<p id="get-price">
							<span><i class="fas fa-won-sign fa-sm"></i><fmt:formatNumber value="${webnovel.product_price}" /></span>
							<span id="pprice" hidden>${webnovel.product_price}</span>
						</p>
						<input type="text" id="like-product-id" value="${webnovel.id}" name="id" hidden />
