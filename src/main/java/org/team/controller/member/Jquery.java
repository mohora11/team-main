...
public class Jquery {
	...
	public String kakaopay() {
		try {
			...
			String parameter = "cid = TC0ONETIME&partner_order_id&partner_user_id=partner_user_id&item_name=5000won&quantity=1&quantity=5500&vat_amount=500&tax_free_amount=0&approval_url=http://localhost/cls/jq/pay.cls&cancel_url&fail_url=&http://localhost/fail&cancel_url=http://localhost/cancel";
